 ...
 * DESCRIPTION: If tree is NULL, return NULL and NULL is returned.
 * and NULL is returned.
 * NOTE : If tree is NULL, return NULL.
 */
const binary_tree_t *get_leaf(const binary_tree_t *tree)
{
	if (is_leaf(tree) == 1)
